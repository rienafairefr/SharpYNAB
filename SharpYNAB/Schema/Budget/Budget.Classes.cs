...
namespace SharpYNAB.Schema.Budget
{
    public partial class Account : Entity
    {
        ...
        public Date LastReconciledDate { get => _lastreconcileddate ; set{ _lastreconcileddate = value;OnPropertyChanged();} } 
            public DateTime _LastReconciledDate_Value { get => LastReconciledDate.Value ; set{ LastReconciledDate.Value = value;OnPropertyChanged(nameof(LastReconciledDate));} } 
        ...
        public Date LastReconciledBalance { get => _lastreconciledbalance ; set{ _lastreconciledbalance = value;OnPropertyChanged();} } 
            public DateTime _LastReconciledBalance_Value { get => LastReconciledBalance.Value ; set{ LastReconciledBalance.Value = value;OnPropertyChanged(nameof(LastReconciledBalance));} } 
        ...
        public Date DirectConnectLastImportedAt { get => _directconnectlastimportedat ; set{ _directconnectlastimportedat = value;OnPropertyChanged();} } 
            public DateTime _DirectConnectLastImportedAt_Value { get => DirectConnectLastImportedAt.Value ; set{ DirectConnectLastImportedAt.Value = value;OnPropertyChanged(nameof(DirectConnectLastImportedAt));} } 
...
#region fields
    ...
    public partial class AccountCalculation : Entity
    {
        ...
        public Amount UnclearedBalance { get => _unclearedbalance ; set{ _unclearedbalance = value;OnPropertyChanged();} } 
            public decimal _UnclearedBalance_Value { get => UnclearedBalance.Value ; set{ UnclearedBalance.Value = value;OnPropertyChanged(nameof(UnclearedBalance));} } 
        ...
        public Amount ClearedBalance { get => _clearedbalance ; set{ _clearedbalance = value;OnPropertyChanged();} } 
            public decimal _ClearedBalance_Value { get => ClearedBalance.Value ; set{ ClearedBalance.Value = value;OnPropertyChanged(nameof(ClearedBalance));} } 
...
#region fields
    ...
    public partial class AccountMapping : Entity
    {
        ...
        public Date DateSequence { get => _datesequence ; set{ _datesequence = value;OnPropertyChanged();} } 
            public DateTime _DateSequence_Value { get => DateSequence.Value ; set{ DateSequence.Value = value;OnPropertyChanged(nameof(DateSequence));} } 
...
#region fields
    ...
    public partial class PayeeRenameCondition : Entity
    {
...
#region fields
    ...
    public partial class MasterCategory : Entity
    {
        [JsonProperty("sortable_index")]
        public int SortableIndex { get => _sortableindex ; set{ _sortableindex = value;OnPropertyChanged();} } 
        [JsonProperty("note")]
...
#region fields
    ...
    public partial class MonthlyAccountCalculation : Entity
    {
        [JsonProperty("warning_count")]
        public string WarningCount { get => _warningcount ; set{ _warningcount = value;OnPropertyChanged();} } 
        [JsonProperty("uncleared_balance")]
        ...
        public Amount RollingBalance { get => _rollingbalance ; set{ _rollingbalance = value;OnPropertyChanged();} } 
            public decimal _RollingBalance_Value { get => RollingBalance.Value ; set{ RollingBalance.Value = value;OnPropertyChanged(nameof(RollingBalance));} } 
        [JsonProperty("month")]
...
#region fields
    ...
    public partial class MonthlyBudget : Entity
    {
        [JsonProperty("note")]
        public string Note { get => _note ; set{ _note = value;OnPropertyChanged();} } 
        [JsonProperty("month")]
        ...
        public Date Month { get => _month ; set{ _month = value;OnPropertyChanged();} } 
            public DateTime _Month_Value { get => Month.Value ; set{ Month.Value = value;OnPropertyChanged(nameof(Month));} } 
...
#region fields
    ...
    public partial class MonthlyBudgetCalculation : Entity
    {
        ...
        public Amount UncategorizedCreditOutflows { get => _uncategorizedcreditoutflows ; set{ _uncategorizedcreditoutflows = value;OnPropertyChanged();} } 
            public decimal _UncategorizedCreditOutflows_Value { get => UncategorizedCreditOutflows.Value ; set{ UncategorizedCreditOutflows.Value = value;OnPropertyChanged(nameof(UncategorizedCreditOutflows));} } 
        ...
        public Amount UncategorizedCashOutflows { get => _uncategorizedcashoutflows ; set{ _uncategorizedcashoutflows = value;OnPropertyChanged();} } 
            public decimal _UncategorizedCashOutflows_Value { get => UncategorizedCashOutflows.Value ; set{ UncategorizedCashOutflows.Value = value;OnPropertyChanged(nameof(UncategorizedCashOutflows));} } 
        ...
        public Amount UncategorizedBalance { get => _uncategorizedbalance ; set{ _uncategorizedbalance = value;OnPropertyChanged();} } 
            public decimal _UncategorizedBalance_Value { get => UncategorizedBalance.Value ; set{ UncategorizedBalance.Value = value;OnPropertyChanged(nameof(UncategorizedBalance));} } 
        [JsonProperty("previous_income")]
        [NotMapped]
        public Amount PreviousIncome { get => _previousincome ; set{ _previousincome = value;OnPropertyChanged();} } 
            public decimal _PreviousIncome_Value { get => PreviousIncome.Value ; set{ PreviousIncome.Value = value;OnPropertyChanged(nameof(PreviousIncome));} } 
        [JsonProperty("over_spent")]
        [NotMapped]
        public Amount OverSpent { get => _overspent ; set{ _overspent = value;OnPropertyChanged();} } 
            public decimal _OverSpent_Value { get => OverSpent.Value ; set{ OverSpent.Value = value;OnPropertyChanged(nameof(OverSpent));} } 
        ...
        public Amount ImmediateIncome { get => _immediateincome ; set{ _immediateincome = value;OnPropertyChanged();} } 
            public decimal _ImmediateIncome_Value { get => ImmediateIncome.Value ; set{ ImmediateIncome.Value = value;OnPropertyChanged(nameof(ImmediateIncome));} } 
        ...
        public Amount HiddenCreditOutflows { get => _hiddencreditoutflows ; set{ _hiddencreditoutflows = value;OnPropertyChanged();} } 
            public decimal _HiddenCreditOutflows_Value { get => HiddenCreditOutflows.Value ; set{ HiddenCreditOutflows.Value = value;OnPropertyChanged(nameof(HiddenCreditOutflows));} } 
        ...
        public Amount HiddenCashOutflows { get => _hiddencashoutflows ; set{ _hiddencashoutflows = value;OnPropertyChanged();} } 
            public decimal _HiddenCashOutflows_Value { get => HiddenCashOutflows.Value ; set{ HiddenCashOutflows.Value = value;OnPropertyChanged(nameof(HiddenCashOutflows));} } 
        [JsonProperty("hidden_budgeted")]
        [NotMapped]
        public Amount HiddenBudgeted { get => _hiddenbudgeted ; set{ _hiddenbudgeted = value;OnPropertyChanged();} } 
            public decimal _HiddenBudgeted_Value { get => HiddenBudgeted.Value ; set{ HiddenBudgeted.Value = value;OnPropertyChanged(nameof(HiddenBudgeted));} } 
        [JsonProperty("hidden_balance")]
        [NotMapped]
        public Amount HiddenBalance { get => _hiddenbalance ; set{ _hiddenbalance = value;OnPropertyChanged();} } 
            public decimal _HiddenBalance_Value { get => HiddenBalance.Value ; set{ HiddenBalance.Value = value;OnPropertyChanged(nameof(HiddenBalance));} } 
        ...
        public Amount DeferredIncome { get => _deferredincome ; set{ _deferredincome = value;OnPropertyChanged();} } 
            public decimal _DeferredIncome_Value { get => DeferredIncome.Value ; set{ DeferredIncome.Value = value;OnPropertyChanged(nameof(DeferredIncome));} } 
        [JsonProperty("credit_outflows")]
        [NotMapped]
        public Amount CreditOutflows { get => _creditoutflows ; set{ _creditoutflows = value;OnPropertyChanged();} } 
            public decimal _CreditOutflows_Value { get => CreditOutflows.Value ; set{ CreditOutflows.Value = value;OnPropertyChanged(nameof(CreditOutflows));} } 
        [JsonProperty("cash_outflows")]
        [NotMapped]
        public Amount CashOutflows { get => _cashoutflows ; set{ _cashoutflows = value;OnPropertyChanged();} } 
            public decimal _CashOutflows_Value { get => CashOutflows.Value ; set{ CashOutflows.Value = value;OnPropertyChanged(nameof(CashOutflows));} } 
        ...
        public Amount AdditionalToBeBudgeted { get => _additionaltobebudgeted ; set{ _additionaltobebudgeted = value;OnPropertyChanged();} } 
            public decimal _AdditionalToBeBudgeted_Value { get => AdditionalToBeBudgeted.Value ; set{ AdditionalToBeBudgeted.Value = value;OnPropertyChanged(nameof(AdditionalToBeBudgeted));} } 
...
#region fields
    ...
    public partial class MonthlySubcategoryBudget : Entity
    {
        ...
        public Amount Budgeted { get => _budgeted ; set{ _budgeted = value;OnPropertyChanged();} } 
            public decimal _Budgeted_Value { get => Budgeted.Value ; set{ Budgeted.Value = value;OnPropertyChanged(nameof(Budgeted));} } 
...
#region fields
    ...
    public partial class UpcomingInstance : Entity
    {
...
#region fields
    ...
    public partial class Transaction : Entity
    {
        ...
        public Amount SubcategoryCreditAmountPreceding { get => _subcategorycreditamountpreceding ; set{ _subcategorycreditamountpreceding = value;OnPropertyChanged();} } 
            public decimal _SubcategoryCreditAmountPreceding_Value { get => SubcategoryCreditAmountPreceding.Value ; set{ SubcategoryCreditAmountPreceding.Value = value;OnPropertyChanged(nameof(SubcategoryCreditAmountPreceding));} } 
        [JsonProperty("source")]
        ...
        public Date ImportedDate { get => _importeddate ; set{ _importeddate = value;OnPropertyChanged();} } 
            public DateTime _ImportedDate_Value { get => ImportedDate.Value ; set{ ImportedDate.Value = value;OnPropertyChanged(nameof(ImportedDate));} } 
        [JsonProperty("flag")]
        ...
        public Date DateEnteredFromSchedule { get => _dateenteredfromschedule ; set{ _dateenteredfromschedule = value;OnPropertyChanged();} } 
            public DateTime _DateEnteredFromSchedule_Value { get => DateEnteredFromSchedule.Value ; set{ DateEnteredFromSchedule.Value = value;OnPropertyChanged(nameof(DateEnteredFromSchedule));} } 
        [JsonProperty("date")]
        [NotMapped]
        public Date Date { get => _date ; set{ _date = value;OnPropertyChanged();} } 
            public DateTime _Date_Value { get => Date.Value ; set{ Date.Value = value;OnPropertyChanged(nameof(Date));} } 
        ...
        public Amount CreditAmount { get => _creditamount ; set{ _creditamount = value;OnPropertyChanged();} } 
            public decimal _CreditAmount_Value { get => CreditAmount.Value ; set{ CreditAmount.Value = value;OnPropertyChanged(nameof(CreditAmount));} } 
        ...
        public Amount CashAmount { get => _cashamount ; set{ _cashamount = value;OnPropertyChanged();} } 
            public decimal _CashAmount_Value { get => CashAmount.Value ; set{ CashAmount.Value = value;OnPropertyChanged(nameof(CashAmount));} } 
        [JsonProperty("amount")]
        [NotMapped]
        public Amount Amount { get => _amount ; set{ _amount = value;OnPropertyChanged();} } 
            public decimal _Amount_Value { get => Amount.Value ; set{ Amount.Value = value;OnPropertyChanged(nameof(Amount));} } 
...
#region fields
    ...
    public partial class Subtransaction : Entity
    {
        [JsonProperty("transfer_transaction_id")]
        [ForeignKey(nameof(TransferTransaction))]
        public Guid TransferTransactionId { get => _transfertransactionid ; set{ _transfertransactionid = value;OnPropertyChanged();} } 
...
#region fields
    ...
    public partial class Subcategory : Entity
    {
        ...
        public Amount TargetBalance { get => _targetbalance ; set{ _targetbalance = value;OnPropertyChanged();} } 
            public decimal _TargetBalance_Value { get => TargetBalance.Value ; set{ TargetBalance.Value = value;OnPropertyChanged(nameof(TargetBalance));} } 
        [JsonProperty("sortable_index")]
        public int SortableIndex { get => _sortableindex ; set{ _sortableindex = value;OnPropertyChanged();} } 
        [JsonProperty("note")]
        public string Note { get => _note ; set{ _note = value;OnPropertyChanged();} } 
...
#region fields
    ...
    public partial class ScheduledTransaction : Entity
    {
        [JsonIgnore]
...
#region fields
    ...
    public partial class ScheduledSubtransaction : Entity
    {
        [JsonProperty("transfer_account_id")]
        [ForeignKey(nameof(TransferAccount))]
        public Guid TransferAccountId { get => _transferaccountid ; set{ _transferaccountid = value;OnPropertyChanged();} } 
...
#region fields
    ...
    public partial class PayeeLocation : Entity
    {
...
#region fields
    ...
    public partial class Payee : Entity
    {
        ...
        public Amount AutoFillAmount { get => _autofillamount ; set{ _autofillamount = value;OnPropertyChanged();} } 
            public decimal _AutoFillAmount_Value { get => AutoFillAmount.Value ; set{ AutoFillAmount.Value = value;OnPropertyChanged(nameof(AutoFillAmount));} } 
...
#region fields
    ...
    public partial class MonthlySubcategoryBudgetCalculation : Entity
    {
        ...
        public Amount UpcomingTransactions { get => _upcomingtransactions ; set{ _upcomingtransactions = value;OnPropertyChanged();} } 
            public decimal _UpcomingTransactions_Value { get => UpcomingTransactions.Value ; set{ UpcomingTransactions.Value = value;OnPropertyChanged(nameof(UpcomingTransactions));} } 
        ...
        public Amount UnbudgetedCreditOutflows { get => _unbudgetedcreditoutflows ; set{ _unbudgetedcreditoutflows = value;OnPropertyChanged();} } 
            public decimal _UnbudgetedCreditOutflows_Value { get => UnbudgetedCreditOutflows.Value ; set{ UnbudgetedCreditOutflows.Value = value;OnPropertyChanged(nameof(UnbudgetedCreditOutflows));} } 
        ...
        public Amount UnbudgetedCashOutflows { get => _unbudgetedcashoutflows ; set{ _unbudgetedcashoutflows = value;OnPropertyChanged();} } 
            public decimal _UnbudgetedCashOutflows_Value { get => UnbudgetedCashOutflows.Value ; set{ UnbudgetedCashOutflows.Value = value;OnPropertyChanged(nameof(UnbudgetedCashOutflows));} } 
        ...
        public Amount SpentPreviousMonth { get => _spentpreviousmonth ; set{ _spentpreviousmonth = value;OnPropertyChanged();} } 
            public decimal _SpentPreviousMonth_Value { get => SpentPreviousMonth.Value ; set{ SpentPreviousMonth.Value = value;OnPropertyChanged(nameof(SpentPreviousMonth));} } 
        [JsonProperty("spent_average")]
        [NotMapped]
        public Amount SpentAverage { get => _spentaverage ; set{ _spentaverage = value;OnPropertyChanged();} } 
            public decimal _SpentAverage_Value { get => SpentAverage.Value ; set{ SpentAverage.Value = value;OnPropertyChanged(nameof(SpentAverage));} } 
        ...
        public Amount PositiveCashOutflows { get => _positivecashoutflows ; set{ _positivecashoutflows = value;OnPropertyChanged();} } 
            public decimal _PositiveCashOutflows_Value { get => PositiveCashOutflows.Value ; set{ PositiveCashOutflows.Value = value;OnPropertyChanged(nameof(PositiveCashOutflows));} } 
        ...
        public Amount PaymentPreviousMonth { get => _paymentpreviousmonth ; set{ _paymentpreviousmonth = value;OnPropertyChanged();} } 
            public decimal _PaymentPreviousMonth_Value { get => PaymentPreviousMonth.Value ; set{ PaymentPreviousMonth.Value = value;OnPropertyChanged(nameof(PaymentPreviousMonth));} } 
        [JsonProperty("payment_average")]
        [NotMapped]
        public Amount PaymentAverage { get => _paymentaverage ; set{ _paymentaverage = value;OnPropertyChanged();} } 
            public decimal _PaymentAverage_Value { get => PaymentAverage.Value ; set{ PaymentAverage.Value = value;OnPropertyChanged(nameof(PaymentAverage));} } 
        ...
        public Amount GoalOverallLeft { get => _goaloverallleft ; set{ _goaloverallleft = value;OnPropertyChanged();} } 
            public decimal _GoalOverallLeft_Value { get => GoalOverallLeft.Value ; set{ GoalOverallLeft.Value = value;OnPropertyChanged(nameof(GoalOverallLeft));} } 
        ...
        public Amount GoalOverallFunded { get => _goaloverallfunded ; set{ _goaloverallfunded = value;OnPropertyChanged();} } 
            public decimal _GoalOverallFunded_Value { get => GoalOverallFunded.Value ; set{ GoalOverallFunded.Value = value;OnPropertyChanged(nameof(GoalOverallFunded));} } 
        ...
        public Amount BudgetedSpending { get => _budgetedspending ; set{ _budgetedspending = value;OnPropertyChanged();} } 
            public decimal _BudgetedSpending_Value { get => BudgetedSpending.Value ; set{ BudgetedSpending.Value = value;OnPropertyChanged(nameof(BudgetedSpending));} } 
        ...
        public Amount BudgetedPreviousMonth { get => _budgetedpreviousmonth ; set{ _budgetedpreviousmonth = value;OnPropertyChanged();} } 
            public decimal _BudgetedPreviousMonth_Value { get => BudgetedPreviousMonth.Value ; set{ BudgetedPreviousMonth.Value = value;OnPropertyChanged(nameof(BudgetedPreviousMonth));} } 
        ...
        public Amount BudgetedCreditOutflows { get => _budgetedcreditoutflows ; set{ _budgetedcreditoutflows = value;OnPropertyChanged();} } 
            public decimal _BudgetedCreditOutflows_Value { get => BudgetedCreditOutflows.Value ; set{ BudgetedCreditOutflows.Value = value;OnPropertyChanged(nameof(BudgetedCreditOutflows));} } 
        ...
        public Amount BudgetedCashOutflows { get => _budgetedcashoutflows ; set{ _budgetedcashoutflows = value;OnPropertyChanged();} } 
            public decimal _BudgetedCashOutflows_Value { get => BudgetedCashOutflows.Value ; set{ BudgetedCashOutflows.Value = value;OnPropertyChanged(nameof(BudgetedCashOutflows));} } 
        ...
        public Amount BudgetedAverage { get => _budgetedaverage ; set{ _budgetedaverage = value;OnPropertyChanged();} } 
            public decimal _BudgetedAverage_Value { get => BudgetedAverage.Value ; set{ BudgetedAverage.Value = value;OnPropertyChanged(nameof(BudgetedAverage));} } 
        ...
        public Amount BalancePreviousMonth { get => _balancepreviousmonth ; set{ _balancepreviousmonth = value;OnPropertyChanged();} } 
            public decimal _BalancePreviousMonth_Value { get => BalancePreviousMonth.Value ; set{ BalancePreviousMonth.Value = value;OnPropertyChanged(nameof(BalancePreviousMonth));} } 
        [JsonProperty("balance")]
        [NotMapped]
        public Amount Balance { get => _balance ; set{ _balance = value;OnPropertyChanged();} } 
            public decimal _Balance_Value { get => Balance.Value ; set{ Balance.Value = value;OnPropertyChanged(nameof(Balance));} } 
        ...
        public Amount AllSpendingSinceLastPayment { get => _allspendingsincelastpayment ; set{ _allspendingsincelastpayment = value;OnPropertyChanged();} } 
            public decimal _AllSpendingSinceLastPayment_Value { get => AllSpendingSinceLastPayment.Value ; set{ AllSpendingSinceLastPayment.Value = value;OnPropertyChanged(nameof(AllSpendingSinceLastPayment));} } 
        [JsonProperty("all_spending")]
        [NotMapped]
        public Amount AllSpending { get => _allspending ; set{ _allspending = value;OnPropertyChanged();} } 
            public decimal _AllSpending_Value { get => AllSpending.Value ; set{ AllSpending.Value = value;OnPropertyChanged(nameof(AllSpending));} } 
        [JsonProperty("additional_to_be_budgeted")]
